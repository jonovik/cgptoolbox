...
project = 'cgptoolbox'
copyright = '2011, Jon Olav Vik, '  #@ReservedAssignment pylint:disable=W0622
copyright += 'Arne Bjørke Gjuvsland, Yunpeng Wang'
...
latex_documents = [
  ('index', 'cgptoolbox.tex', 'cgptoolbox Documentation',
   'Jon Olav Vik, Arne Bjørke Gjuvsland, Yunpeng Wang', 'manual'),
]
...
man_pages = [
    ('index', 'cgptoolbox', 'cgptoolbox Documentation',
     ['Jon Olav Vik, Arne Bjørke Gjuvsland, Yunpeng Wang'], 1)
]
...
texinfo_documents = [
  ('index', 'cgptoolbox', 'cgptoolbox Documentation', 
    'Jon Olav Vik, Arne Bjørke Gjuvsland, Yunpeng Wang', 'cgptoolbox', 
...
# The undocumented default is "import numpy as np, matplotlib.pyplot as plt"
#plot_pre_code = "from pylab import *"


# Example configuration for intersphinx: refer to the Python standard library.
# http://sphinx.pocoo.org/latest/ext/intersphinx.html#confval-intersphinx_mapping
# If no documentation set contains the referenced term, it is rendered in bold 
# but not hyperlinked. For example, commenting out "sphinx" below will render 
# :mod:`~sphinx.ext.intersphinx` as bold unlinked text.
intersphinx_mapping = {
    'python': ('http://docs.python.org', None),
    'sphinx': ('http://sphinx.pocoo.org/latest', None),
