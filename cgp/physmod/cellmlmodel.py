...
def test_cellmlmodel2():
    Cellmlmodel2("http://models.cellml.org/workspace/tentusscher_noble_noble_panfilov_2004/@@rawfile/3e0eeae90b16221bb1ca327a5572de482990cacc/tentusscher_noble_noble_panfilov_2004_a.cellml", use_cython=False, purge=True)

class Cellmlmodel2(Namedcvodeint):
    
    def __init__(self,  # pylint: disable=W0102,E1002,R
        url, t=[0, 1], y=None, p=None, rename={}, use_cython=True, purge=True, 
        **kwargs):
        self.url = url
        ...
        super(Cellmlmodel2, self).__init__(self.model.ode, t, 
    ...
    def _import_python(self):
        try:
            ...
            # Download generated Python code for CellML model at url
            # Prefix hash to avoid starting with numbers
            # Use only first few chars
            # Use relative import, "._cellml2py.{hash}.py", "cgp.physmod"
            with write_if_not_exists(os.path.join(self.packagedir, 
                                                  "__init__.py")) as f:
                pass  # just create empty __init__.py to make a package 
            with write_if_not_exists(os.path.join(self.packagedir, 
                                                  "py.py")) as f:
                f.write(urlcache("http://bebiservice.umb.no/cellml2py/" + self.url))
            self.model = import_module(".py", self.package)
...
"""
    ...
    def get_latest_exposure(self, fmt="workspace/{workspace}"):
        ...
        ...     def __init__(self):
        ...         self.cellml_home = "http://models.cellml.org/"
