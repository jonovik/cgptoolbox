...
def rates_and_algebraic(t, y):
    ...
    >>> from cellmlmodels.cellmlmodel import Cellmlmodel
    >>> changeset_workspace = "d331505e3d8c60c257ce709bf744d31121525066/bondarenko_szigeti_bett_kim_rasmusson_2004"
...
class Cellmlmodel(Namedcvodeint):
    ...
    Attributes (with the van der Pol model as the default example):
        ...
        in the cellmlmodels/cellml2py/ directory. This code is wrapped to be 
        ...
        <module 'cellmlmodels.cellml2py.vanderpol_vandermark_19285756af26cf...' from ...>
        >>> vdp_compiled.model
        <module 'cellmlmodels.cellml2py.cython.vanderpol...' from ...>
    ...
    '7d389f37a44c59826f5fde1fe3df15dbe5417274'
    ...
    def __init__(self, exposure_workspace="5756af26cfb20a7f66a51f66af10a70a/vanderpol_vandermark_1928",
        ...
        **kwargs):
        ...
        Cython files are placed in cellmlmodels/cellml2py/cython/modulename/, 
        and cellmlmodels.cellml2py.cython.modulename.modulename is used 
        in place of cellmlmodels.cellml2py.modulename.
        ...
        modulename = 'cellmlmodels.cellml2py.' + modelname
        ...
        try:
            ...
            if "computeRates" in py_code:
                ...
                # look for existing .py.orig file in cellmlmodels/cellml2py
    ...
    def cythonize(self, modelname, modulename, modelfilename):
        ...
        This just imports and calls cellmlmodels.cythonize.cythonize_model().
        """
        ...
        try:
            ...
            # deferred import to minimize dependencies
            from cellmlmodels.cythonize import cythonize_model
            from utils.write_if_not_exists import write_if_not_exists
